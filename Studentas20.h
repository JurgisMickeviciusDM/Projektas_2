#ifndef STUDENTASV20_H
#define STUDENTASV20_H
...
public:// laisvi, neprivatus konstruktorius
    ...
    friend std::istream& operator>>(std::istream& is, Studentas& studentas) {
        ...
        // Pavardës ávedimas su patikrinimu
        ...
        // Paþymiø skaièiaus ávedimas su patikrinimu
        ...
        if (generuotiAtsitiktinai == "taip") {
            ...
            while (!(is >> pazymiuSk) || pazymiuSk <= 0) {
                is.clear();
                is.ignore(std::numeric_limits<std::streamsize>::max(), '\n');
                std::cout << "Neteisinga ivestis. Iveskite teigiamà pazymiu skaiciu: ";
            }
            ...
            // Egzamino rezultato ávedimas su patikrinimu
