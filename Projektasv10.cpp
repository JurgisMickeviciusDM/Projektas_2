...
int main() { 
    ...
    if (inputMethod == "auto") {
        ...
        list<int> studentuSkaiciai = { 1000 };
        ...
        for (int n : studentuSkaiciai) {
            ...
            Rusiuoti(studentai, vargsiukai, kietiakiai, sortChoice); // Make sure choice2 is not empty and has a valid character
    ...
    if (inputMethod == "duomenys" || inputMethod == "ranka") {
        ...
        output << std::fixed << std::setprecision(2);  // To ensure 0.00 format
        ...
        cout << output.str(); // Print the student data
    }
